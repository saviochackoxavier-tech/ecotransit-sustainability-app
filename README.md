...
![EcoTransit dashboard hero](docs/assets/ecotransit-dashboard-hero.png)
...
![EcoTransit live tracking
map](docs/assets/ecotransit-live-tracking-map.png)
...
![EcoTransit gamification
achievements](docs/assets/ecotransit-gamification-achievement.png)
...
![EcoTransit journey
history](docs/assets/ecotransit-journey-history.png)
...
1.  **Visibility** --- users can see the estimated carbon impact of
    their journeys.
2.  **Engagement** --- points, achievements, and streaks make
    sustainable travel progress visible.
3.  **Data** --- aggregated staff-facing analytics can help demonstrate
...
![EcoTransit architecture and data
flow](docs/assets/ecotransit-architecture-flow.png)
...
**Presentation deck:**
[`docs/EcoTransit-V1-Presentation.pptx`](docs/EcoTransit-V1-Presentation.pptx)

## Presentation Highlights

### 01 --- Cover

![EcoTransit V1 presentation ---
cover](docs/assets/presentation/slide-01.png)

### 02 --- Foundation & SDG Alignment

![EcoTransit V1 presentation --- SDG
alignment](docs/assets/presentation/slide-02.png)

### 03 --- Problem Statement

![EcoTransit V1 presentation --- problem
statement](docs/assets/presentation/slide-03.png)

### 04 --- Empathize & Target Users

![EcoTransit V1 presentation --- target
users](docs/assets/presentation/slide-04.png)

### 05 --- Technical & Solution Overview

![EcoTransit V1 presentation --- solution
overview](docs/assets/presentation/slide-05.png)

### 06 --- Architecture & Gamification

![EcoTransit V1 presentation --- architecture and
gamification](docs/assets/presentation/slide-06.png)

### 07 --- Prototype & Live Demo Workflow

![EcoTransit V1 presentation ---
workflow](docs/assets/presentation/slide-07.png)

### 08 --- Robust Quality & Testing

![EcoTransit V1 presentation ---
testing](docs/assets/presentation/slide-08.png)

### 09 --- Responsible AI & Ethics

![EcoTransit V1 presentation --- responsible
design](docs/assets/presentation/slide-09.png)

### 10 --- Impact Statement & Expected Outcomes

![EcoTransit V1 presentation ---
impact](docs/assets/presentation/slide-10.png)

### 11 --- Conclusion

![EcoTransit V1 presentation ---
conclusion](docs/assets/presentation/slide-11.png)
